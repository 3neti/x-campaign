...
class XCampaignServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(BuildsCampaignHostMutationAuthorizationChecklists::class, CampaignHostMutationAuthorizationChecklistBuilder::class);
        ...
        $this->app->singleton(CampaignWorksheetIntakeRepository::class, EloquentCampaignWorksheetIntakeRepository::class);
