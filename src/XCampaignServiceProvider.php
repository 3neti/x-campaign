...
class XCampaignServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(BuildsCampaignCockpitConsumptionMaps::class, CampaignCockpitConsumptionMapBuilder::class);
        $this->app->singleton(BuildsCampaignCockpitSummaries::class, CampaignCockpitSummaryBuilder::class);
        $this->app->singleton(PresentsCampaignCockpitApiResponses::class, CampaignCockpitApiResponsePresenter::class);
        ...
        $this->app->singleton(CampaignHostIntegrationWorkspace::class, RepositoryBackedCampaignHostIntegrationWorkspace::class);
