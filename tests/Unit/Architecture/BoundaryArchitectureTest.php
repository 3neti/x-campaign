...
it('does not scaffold routes controllers or execution owners outside authorized slices', function () {
...
it('keeps phase one t recipient attachment mutation workspace free of durable persistence queues delivery and issuance', function () {
    $source = collect([
        __DIR__.'/../../../src/Workspaces/RepositoryBackedCampaignAudienceImportRecipientAttachmentMutationWorkspace.php',
        __DIR__.'/../../../src/Contracts/CampaignAudienceImportRecipientAttachmentMutationWorkspace.php',
        __DIR__.'/../../../src/Data/CampaignAudienceImportRecipientAttachmentMutationWorkspaceResultData.php',
    ])->filter(fn (string $file): bool => is_file($file))
        ->map(fn (string $file): string => file_get_contents($file) ?: '')
        ->implode("\n");
...
it('keeps phase one u recipient attachment mutation summaries free of durable persistence queues delivery and issuance', function () {
    $source = collect([
        __DIR__.'/../../../src/ReadModels/CampaignAudienceImportRecipientAttachmentMutationSummaryReadModel.php',
        __DIR__.'/../../../src/Contracts/BuildsCampaignAudienceImportRecipientAttachmentMutationSummaries.php',
        __DIR__.'/../../../src/Data/CampaignAudienceImportRecipientAttachmentMutationSummaryData.php',
    ])->filter(fn (string $file): bool => is_file($file))
        ->map(fn (string $file): string => file_get_contents($file) ?: '')
        ->implode("\n");
...
it('keeps phase one v attachment operator read model aggregation free of durable persistence queues delivery and issuance', function () {
    $source = collect([
        __DIR__.'/../../../src/ReadModels/CampaignAudienceImportAttachmentOperatorReadModel.php',
        __DIR__.'/../../../src/Contracts/BuildsCampaignAudienceImportAttachmentOperatorReadModels.php',
        __DIR__.'/../../../src/Data/CampaignAudienceImportAttachmentOperatorReadModelData.php',
    ])->filter(fn (string $file): bool => is_file($file))
        ->map(fn (string $file): string => file_get_contents($file) ?: '')
        ->implode("\n");
...
it('keeps phase one w attachment operator workspace free of durable persistence queues delivery and issuance', function () {
    $source = collect([
        __DIR__.'/../../../src/Workspaces/RepositoryBackedCampaignAudienceImportAttachmentOperatorWorkspace.php',
        __DIR__.'/../../../src/Contracts/CampaignAudienceImportAttachmentOperatorWorkspace.php',
        __DIR__.'/../../../src/Data/CampaignAudienceImportAttachmentOperatorWorkspaceResultData.php',
    ])->filter(fn (string $file): bool => is_file($file))
        ->map(fn (string $file): string => file_get_contents($file) ?: '')
        ->implode("\n");
...
it('keeps phase one x attachment operator workspace collections free of durable persistence queues delivery and issuance', function () {
    $source = collect([
        __DIR__.'/../../../src/ReadModels/CampaignAudienceImportAttachmentOperatorWorkspaceCollectionReadModel.php',
        __DIR__.'/../../../src/Contracts/BuildsCampaignAudienceImportAttachmentOperatorWorkspaceCollections.php',
        __DIR__.'/../../../src/Data/CampaignAudienceImportAttachmentOperatorWorkspaceCollectionData.php',
    ])->filter(fn (string $file): bool => is_file($file))
        ->map(fn (string $file): string => file_get_contents($file) ?: '')
        ->implode("\n");
...
it('keeps phase one y attachment operator workspace collection workspace free of durable persistence queues delivery and issuance', function () {
    $source = collect([
        __DIR__.'/../../../src/Workspaces/RepositoryBackedCampaignAudienceImportAttachmentOperatorWorkspaceCollectionWorkspace.php',
        __DIR__.'/../../../src/Contracts/CampaignAudienceImportAttachmentOperatorWorkspaceCollectionWorkspace.php',
        __DIR__.'/../../../src/Data/CampaignAudienceImportAttachmentOperatorWorkspaceCollectionWorkspaceResultData.php',
    ])->filter(fn (string $file): bool => is_file($file))
        ->map(fn (string $file): string => file_get_contents($file) ?: '')
        ->implode("\n");
...
it('keeps phase one z attachment operator workspace collection operator summaries free of durable persistence queues delivery and issuance', function () {
    $source = collect([
        __DIR__.'/../../../src/ReadModels/CampaignAudienceImportAttachmentOperatorWorkspaceCollectionOperatorSummaryReadModel.php',
        __DIR__.'/../../../src/Contracts/BuildsCampaignAudienceImportAttachmentOperatorWorkspaceCollectionOperatorSummaries.php',
        __DIR__.'/../../../src/Data/CampaignAudienceImportAttachmentOperatorWorkspaceCollectionOperatorSummaryData.php',
    ])->filter(fn (string $file): bool => is_file($file))
        ->map(fn (string $file): string => file_get_contents($file) ?: '')
        ->implode("\n");
